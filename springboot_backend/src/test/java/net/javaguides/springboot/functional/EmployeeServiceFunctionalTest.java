...
public class EmployeeServiceFunctionalTest {
    ...
    public void testAddEmp(){
        ...
        ExtractableResponse<Response> response = RestAssured
                ...
                .body("{\"firstname\": \"Sahal\", \"lastname\":\"Yousuf\", \"emailid\":\"sahal.yousuf10@gmail.com\", \"departmentId\":\"13\"}") // try to get this body from a file (file.json)
                .when()
    ...
    public void testUpdateEmp(){
        ...
        ExtractableResponse<Response> response = RestAssured
                ...
                .filter(new RequestLoggingFilter())
                .contentType(ContentType.JSON)
                .body("{\"firstname\": \"Haris\", \"lastname\":\"Khurram\", \"emailid\":\"haris.khurram10@gmail.com\", \"departmentId\":\"14\"}") // try to get this body from a file (file.json)
                .when()
